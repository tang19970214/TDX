  ...
  <div class="digitallnvestment">
    ...
    <div class="digitallnvestment__form">
      <el-form class="form" ref="form" :model="ruleForm" :rules="rules" label-position="top">
        ...
        <div class="form__question">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司投入數位轉型至今大約多久？" prop="b11">
            <el-radio-group v-model="ruleForm.b11" @change="getB11">
              ...
              <el-radio label="超過3年"></el-radio>
            </el-radio-group>
          </el-form-item>
        </div>

        <!-- 8 b12 -->
        <div class="form__question" v-if="!!ruleForm.b11 && ruleForm.b11 !== '還在評估中'">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司在去(2020)年推動數位轉型的投資經費? (包括人事、系統開發或委外等相關費用)" prop="b11">
            <el-radio-group v-model="ruleForm.b12">
              <el-radio label="沒有投入經費"></el-radio>
              <el-radio label="不到100萬"></el-radio>
              <el-radio label="100萬(含)以上，不到500萬"></el-radio>
              <el-radio label="500萬(含)以上，不到1,000萬"></el-radio>
              <el-radio label="1,000萬(含)以上，不到5,000萬"></el-radio>
              <el-radio label="5,000萬(含)以上"></el-radio>
        ...
        <!-- 9 b13 -->
        <div class="form__question" v-if="!!ruleForm.b12 && ruleForm.b12 !== '沒有投入經費'">
        ...
        <div class="digitallnvestment__form--subTitle" v-if="!!ruleForm.b12 && ruleForm.b12 !== '沒有投入經費'">
        ...
        <div class="form__question" v-if="!!ruleForm.b12 && ruleForm.b12 !== '沒有投入經費'">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司2020年實際參與推動數位轉型的專職人員有幾位？" prop="b15">
            <el-radio-group v-model="ruleForm.b15">
              <el-radio label="沒有專職人員"></el-radio>
              <el-radio label="1～2人"></el-radio>
              <el-radio label="3～5人"></el-radio>
              <el-radio label="6～10人"></el-radio>
              <el-radio label="11～20人"></el-radio>
            </el-radio-group>
            <div class="form__question--ansOther" :class="{'active': ruleForm.b15=='20人以上，大約_____人' || !!b15_other}">
              <el-radio label="20人以上，大約_____人" v-model="ruleForm.b15" :class="{'is-foces is-checked': !!b15_other}"></el-radio>
              <el-input v-model="b15_other" type="number" placeholder="填入數字" :disabled="ruleForm.b15 !== '20人以上，大約_____人'"></el-input>
            </div>
          </el-form-item>
        </div>
        ...
        <div class="form__question" v-if="!!ruleForm.b12 && ruleForm.b12 !== '沒有投入經費'">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司目前(2021年)投入多少員工(專職)於數位轉型？" prop="b16">
            ...
            <div class="form__question--ansOther" :class="{'active': ruleForm.b16=='20人以上，大約_____人' || !!b16_other}">
              <el-radio label="20人以上，大約_____人" v-model="ruleForm.b16" :class="{'is-foces is-checked': !!b16_other}"></el-radio>
              <el-input v-model="b16_other" type="number" placeholder="填入數字" :disabled="ruleForm.b16 !== '20人以上，大約_____人'"></el-input>
            </div>
          </el-form-item>
        </div>
        ...
        <div class="form__question" v-if="!!ruleForm.b12 && ruleForm.b12 !== '沒有投入經費'">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司目前(2021年)是否有聘請外部顧問或專家，協助推動數位轉型？" prop="b17">
            <el-radio-group v-model="ruleForm.b17">
              <el-radio label="沒有，也沒有規劃聘請外部顧問"></el-radio>
              <el-radio label="沒有，但已規劃聘請外部顧問"></el-radio>
            </el-radio-group>
            <div class="form__question--ansOther" :class="{'active': ruleForm.b17=='有，大約_____人' || !!b17_other}">
              <el-radio label="有，大約_____人" v-model="ruleForm.b17" :class="{'is-foces is-checked': !!b17_other}"></el-radio>
              <el-input v-model="b17_other" type="number" placeholder="填入數字" :disabled="ruleForm.b17 !== '有，大約_____人'"></el-input>
            </div>
          </el-form-item>
        </div>
        ...
        <div class="form__question" v-if="!!ruleForm.b11">
          ...
          <el-form-item class="form__question--body" label="請問，貴公司目前已經投入/導入哪些數位或資訊系統？(複選題)" prop="b18">
            <el-checkbox-group v-model="ruleForm.b18">
              ...
              <el-checkbox label="其他，請說明___________"></el-checkbox>
